        ...
        <div class="row">
            @if ($vendors->total() > 0)
                ...
                <div class="col-md-12 pb-3 text-center">
                    <h2 style="background-color: rgb(127, 173, 57)">Search Results</h2>
                    <p class="search-results-count">{{ $vendors->total() }} result(s) for '{{ request()->input('query') }}'</p>            
                </div>
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <h4 class="mb-4 py-1" style="background-color: rgb(255, 191, 0);border: none;text-align: center;">Vendor List</h4>
