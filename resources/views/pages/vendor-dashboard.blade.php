...
<style type="text/css">
    ...
    .vendor-bio ul{list-style-type: none;display: inline-flex;}
    .vendor-bio ul li a{color: blue; font-size: 25px}
    .vendor-bio ul li a:hover{color: blue;}
    body {
...
<div class="container border-bottom bg-white mt-1 pt-md-3 pt-2">
    <div class="d-flex flex-md-row justify-content-around align-items-center">
        ...
        <div class="d-flex flex-column" id="info">
            <div class="p-md-1 text-muted"> <span class="fa fa-envelope p-1 rounded-circle"></span> vendor@gmail.com</div>
            <div class="p-md-1 pt-sm-1 text-muted"> <span class="fa fa-phone bg-light p-1 rounded-circle"></span> +880170000000</div>
        </div>
    ...
    <div class="pl-lg-5 pt-lg-2 pt-md-1">
        <div class="featured__controls pt-5">
            <ul>
                ...
                <li data-filter=".selling-product">Selling Products</li>
        ...
        <div class="col-lg-10 col-md-10 col-sm-10 mix selling-product">
            <div class="featured__item">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="{{asset('images/product/product-2.jpg')}}">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
