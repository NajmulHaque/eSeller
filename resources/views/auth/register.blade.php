        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center"
                    style="font-weight: bold;text-transform: uppercase;font-size: 20px;background-color: #7fad39; color: #fff;">
                    {{ __('Sign Up') }}</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control" name="address"
                                    placeholder="Street, Apartment, unite etc.">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password"
                                    ...
                                    required autocomplete="new-password" placeholder="type password">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <p class="pt-3">By clicking the submit button, you agree to our <a href="">Terms &
